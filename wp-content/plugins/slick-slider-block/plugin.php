 ...
 * Description:       Gutenberg Block for Slick Slider uses Slick Slider to create sliders from core blocks.
...
define( 'GB_SLICK_SLIDER_BLOCK_VERSION', '1.0.0' );
...
if ( ! function_exists( 'gb_slick_slider_block_enque_styles_and_scripts' ) ) :
	...
	function gb_slick_slider_block_enque_styles_and_scripts() {
		wp_register_style( 'slick', GB_SLICK_SLIDER_BLOCK_URL . '/assets/slick/slick/slick.css', [],GB_SLICK_SLIDER_BLOCK_VERSION );
		wp_register_style( 'slick-theme', GB_SLICK_SLIDER_BLOCK_URL . '/assets/slick/slick/slick-theme.css', [],GB_SLICK_SLIDER_BLOCK_VERSION );
		...
		wp_register_script( 'slick-js', GB_SLICK_SLIDER_BLOCK_URL . '/assets/slick/slick/slick.min.js', [ 'jquery' ], GB_SLICK_SLIDER_BLOCK_VERSION, false );
