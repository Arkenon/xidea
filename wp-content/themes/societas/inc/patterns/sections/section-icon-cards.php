...
return array(
	...
	'content'    => '<!-- wp:group {"style":{"spacing":{"padding":{"top":"30px","right":"0px","bottom":"30px","left":"0px"}}},"backgroundColor":"light","className":"section-no-block-space","layout":{"inherit":true}} -->
					<div class="wp-block-group section-no-block-space has-light-background-color has-background" style="padding-top:30px;padding-right:0px;padding-bottom:30px;padding-left:0px"><!-- wp:columns {"style":{"spacing":{"padding":{"top":"50px","right":"0px","bottom":"50px","left":"0px"}}}} -->
