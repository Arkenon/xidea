...
<!-- wp:cover {"url":"https://c.pxhere.com/photos/74/7c/entrepreneur_business_corporate_office_business_professional_meeting_professional_business_group-686805.jpg!d","hasParallax":true,"dimRatio":75,"overlayColor":"foreground","minHeight":800,"className":"section-no-block-space","style":{"color":[]}} -->
<div id="hero-section" class="wp-block-cover has-parallax section-no-block-space"
     style="background-image:url(https://c.pxhere.com/photos/74/7c/entrepreneur_business_corporate_office_business_professional_meeting_professional_business_group-686805.jpg!d);min-height:800px">
        ...
        <div id="animated-1" class="wp-block-group wow fadeInLeft">
            ...
            <div class="wp-block-buttons">
                ...
                <div class="wp-block-button"><a
                            ...
                            style="border-radius:25px">Let\'s Start</a></div>
                <!-- /wp:button --></div>
            <!-- /wp:buttons --></div>
        <!-- /wp:group --></div>
</div>
