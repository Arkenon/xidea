...
return array(
	...
	'content'    => '<!-- wp:group {"tagName":"header","style":{"spacing":{"padding":{"right":"0px","left":"0px","top":"20px","bottom":"20px"}}},"backgroundColor":"bglight","textColor":"text-regular","className":"border-bottom","layout":{"inherit":false}} -->
					<header id="header"
					    ...
					    <div class="wp-block-group container">
					        ...
					        <div class="wp-block-group row">
					            <!-- wp:group {"className":"col-10 col-sm-3 align-self-center mt-0"} -->
					            <div class="wp-block-group col-10 col-sm-3 align-self-center mt-0">
					                <!-- wp:site-title {"level":4,"textAlign":"left"} /-->
					            </div>
					            <!-- /wp:group -->
					            ...
					            <div class="wp-block-group col-2 col-sm-9 col-lg-7 mt-0  align-self-center">
					                <!-- wp:navigation {"ref":1506,"textColor":"foreground","layout":{"type":"flex","justifyContent":"center","flexWrap":"nowrap"},"style":{"typography":{"fontSize":"16px","fontStyle":"normal","fontWeight":"700"}}} /--></div>
					            <!-- /wp:group -->
