 ...
 *
 */
function xidea_pro_register_block_patterns() {
	 ...
	 *
	 */
	$block_pattern_categories = apply_filters( 'xidea_pro_block_pattern_categories', $block_pattern_categories );
	 ...
	 *
	 */
	$block_patterns = apply_filters( 'xidea_pro_block_patterns', $block_patterns );
...
add_action( 'init', 'xidea_pro_register_block_patterns', 9 );
