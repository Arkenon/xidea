...
<header id="header" class="wp-block-group" style="border-top-color:var(--wp--preset--color--foreground);border-top-width:3px;padding-top:20px;padding-right:10px;padding-bottom:20px;padding-left:10px"
    ...
    <div class="wp-block-group alignwide">
        ...
        <!-- wp:social-links {"iconColor":"secondary","iconColorValue":"#362706","iconBackgroundColor":"light","iconBackgroundColorValue":"#E9E5D6","size":"has-small-icon-size"} -->
        <ul class="wp-block-social-links has-small-icon-size has-icon-color has-icon-background-color"><!-- wp:social-link {"url":"#","service":"facebook"} /-->
            ...
            <!-- wp:social-links {"iconColor":"secondary","iconColorValue":"#362706","iconBackgroundColor":"light","iconBackgroundColorValue":"#E9E5D6","size":"has-normal-icon-size","className":"blocland-hide-small-devices"} -->
            <ul class="wp-block-social-links has-normal-icon-size has-icon-color has-icon-background-color blocland-hide-small-devices">
