 ...
 */
return array(
	'title'      => __( 'Default Footer With Columns', 'blockstar-pro' ),
	...
	'content'    => '<!-- wp:group {"style":{"spacing":{"padding":{"top":"15px","right":"15px","bottom":"15px","left":"15px"}}},"backgroundColor":"black","className":"tp-site-footer","layout":{"inherit":false,"contentSize":"1170px"}} -->
					...
					<p class="has-text-align-left has-light-color has-text-color">BlockStar is a block based Wordpress
					                        Theme.</p>
					<!-- /wp:paragraph --></div>
					<!-- /wp:group -->
					
					<!-- wp:group {"className":"col col-lg-4  col-md-6 col-sm-12 col-12"} -->
					<div class="wp-block-group col col-lg-4  col-md-6 col-sm-12 col-12"><!-- wp:query {"queryId":44,"query":{"perPage":3,"pages":0,"offset":0,"postType":"post","categoryIds":[],"tagIds":[],"order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false}} -->
