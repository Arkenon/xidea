 ...
 */
return array(
	'title'      => __( 'Default Header With Social Icons', 'blockstar-pro' ),
	...
	'content'    => '<!-- wp:group {"style":{"spacing":{"padding":{"right":"0px","left":"0px","top":"20px","bottom":"20px"}}},"backgroundColor":"background","textColor":"text-regular","className":"border-bottom","layout":{"inherit":false}} -->
					...
					<div class="wp-block-group col-2 col-sm-9 col-lg-7 mt-0  align-self-center"><!-- wp:navigation {"ref":1506,"textColor":"foreground","layout":{"type":"flex","justifyContent":"center","flexWrap":"nowrap"},"style":{"typography":{"fontSize":"16px","fontStyle":"normal","fontWeight":"700"}}} /--></div>
					<!-- /wp:group -->
					
					<!-- wp:group {"className":"d-none d-lg-block mt-0 col-lg-2 align-self-center","layout":{"inherit":true}} -->
					<div class="wp-block-group d-none d-lg-block mt-0 col-lg-2 align-self-center"><!-- wp:social-links {"iconColor":"white","iconColorValue":"#ffffff","customIconBackgroundColor":"#30180d","iconBackgroundColorValue":"#30180d","openInNewTab":true,"layout":{"type":"flex","justifyContent":"right"},"style":{"spacing":{"blockGap":"10px"}}} -->
