...
<!-- wp:group {"tagName":"section","align":"wide","style":{"spacing":{"margin":{"top":"0px"},"padding":{"top":"var:preset|spacing|40","bottom":"var:preset|spacing|40"}}},"backgroundColor":"lightbg","layout":{"type":"constrained"}} -->
<section class="wp-block-group alignwide has-lightbg-background-color has-background" id="about-us-section" style="margin-top:0px;padding-top:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40)"><!-- wp:group {"align":"wide","style":{"spacing":{"padding":{"right":"var:preset|spacing|30","left":"var:preset|spacing|30"}}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"center"}} -->
    <div class="wp-block-group alignwide" style="padding-right:var(--wp--preset--spacing--30);padding-left:var(--wp--preset--spacing--30)"><!-- wp:buttons -->
        ...
        <!-- wp:paragraph {"align":"center","textColor":"links"} -->
        <p class="has-text-align-center has-links-color has-text-color">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
        <!-- /wp:paragraph -->
        ...
        <div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40)"><!-- wp:image {"id":2592,"sizeSlug":"large","linkDestination":"none","style":{"color":{"duotone":["#000000","#ffffff"]}}} -->
            <figure class="wp-block-image size-large"><img src="<?php echo esc_url(get_template_directory_uri().'/assets/img/about-us.jpg'); ?>" alt="" class="wp-image-2592"/></figure>
            <!-- /wp:image --></div>
        <!-- /wp:group -->

        <!-- wp:paragraph {"align":"center","style":{"spacing":{"padding":{"right":"var:preset|spacing|60","left":"var:preset|spacing|60"}}},"textColor":"links","fontSize":"medium"} -->
        <p class="has-text-align-center has-links-color has-text-color has-medium-font-size" style="padding-right:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--60)">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis pulvinar massa sed turpis dapibus sollicitudin. Nullam sodales volutpat ligula, eget malesuada nibh condimentum sed. Curabitur dignissim vehicula arcu. Praesent porta nunc eget sollicitudin volutpat. Integer massa est, mollis ut ornare consectetur, semper eget odio.</p>
        <!-- /wp:paragraph --></div>
    <!-- /wp:group --></section>
<!-- /wp:group -->