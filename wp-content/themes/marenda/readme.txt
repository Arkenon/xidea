...
= 1.1.1 =
* New pattern added (hero-section-2)
* Design revisions
...
* All patterns revised
* Screenshot changed

= 1.0.6 =
* New color variatons added
* Screenshot changed
* Footer social icons bg color changed
...
* Screenshot changed
* Style optimization
* Header menu and footer menu fixed

= 1.0.3 =
* TGMPA updated

= 1.0.2 =
* Heading blocks color variation changed
